...
* Use digital tools and technologies effectively, as well as assess and choose digital tools based on their suitability for specific tasks related to science/academia.
* basic coding skills in BASH & Python and why they are important for scientific work
* coding environments: what they are and how to leverage them for your work
* how to find, evaluate data & Information in a digital environment
* Data-managament and the basics of version control using GITHUB
* how to plan and manage a scientific project and pick the right tools for the job
* produce and distribute multimedia content to convey [the subject's] opinions and thoughts, as well as communicate effectively in digital environments, visulaze data & results
* Understand the ethical and social implications of digital technologies
...
The course is divided into several modules, each covering a different aspect of digital literacy. The modules include interactive lectures, readings, activities, and assessments, (as well as guest lectures from experts in the field). The following section will illustrate the structure of the contents contained.
...
* [Digital literacy](link-to-experiments/experiments.html#)
    ...
    - communication and collaborration
        - data visualization, outreach, (digital storytelling?)


* [Advanced Content](link-to-projects.html)
