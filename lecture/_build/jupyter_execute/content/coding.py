...
# 
# -- expand on: classes, modules, reading in data, making exectuable scripts (https://www.redhat.com/sysadmin/python-scripting-intro)
# 
# ### Sub-chapter 5: Data manipulation using Python Tutorial
# 
